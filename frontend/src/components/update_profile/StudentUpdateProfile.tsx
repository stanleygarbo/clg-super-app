...
const StudentUpdateProfile = () => {
  ...
  return (
    <FormProvider {...methods}>
      <form
        className="flex flex-col gap-10 justify-center mx-auto my-32 w-[800px] border shadow-md rounded-md"
        onSubmit={methods.handleSubmit((data) => {
          console.log(data);
        })}
      >
        <section className="flex justify-between items-end gap-5 pt-10 pb-10 border-b">
          <div className="flex items-end gap-10 pl-10 h-[150px]">
            <span className="flex flex-col gap-1 items-center">
              <p className="font-bold text-center text-blue-600 p-1">Student</p>
