      ...
      <div className="w-[1200px] h-[650px] relative">
        <section className="flex justify-between items-center">
          ...
          {/* <button
            ...
            className="bg-blue-700 px-3 py-2 text-white font-semibold text-sm"
          >
            Add User
          </button> */}
        </section>
        {/* <form
          ...
          } absolute tranform translate-x-1/2 translate-y-1/2  bottom-1/2 bg-white flex flex-col shadow-md p-5 backdrop-blur-md duration-150`}
        >
          ...
          <button className="bg-blue-600 mt-3 py-1 text-white font-bold hover:bg-blue-700 active:scale-95 duration-200">
            Add
          </button>
        </form> */}
