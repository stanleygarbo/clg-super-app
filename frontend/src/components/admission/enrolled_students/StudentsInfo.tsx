...
const StudentsInfo = () => {
  ...
  return (
    <form className="mt-10 mb-14 mx-8 flex flex-col border p-5 rounded-lg w-[1100px] shadow-md gap-5">
      <h1 className="text-xl font-bold mb-10 p-2 rounded-lg text-center">
        Information
      </h1>
      ...
      <h1 className="text-md font-bold text-red-500">Father Information : </h1>
      <span className="grid grid-cols-4 gap-2">
        <section className="relative rounded-lg">
          <p className="text-xs font-bold absolute text-slate-600 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white">
            Last Name
      ...
      <h1 className="text-md font-bold text-red-500">Mother Information : </h1>
      <span className="grid grid-cols-4 gap-2">
        <section className="relative rounded-lg">
          <p className="text-xs font-bold absolute text-slate-600 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white">
            Last Name
      ...
      <span className="grid grid-cols-3 gap-2">
        ...
        <section className="relative rounded-lg">
          ...
          <input
            type="text"
            readOnly
            value={students?.studentData.guardianSpouseFirstName}
            className="border border-slate-500 h-[35px] w-[100%] py-1 rounded-md font-bold text-center overflow-hidden px-1"
          />
        </section>
        <section className="relative rounded-lg">
          ...
          <input
            type="text"
            readOnly
            value={students?.studentData.guardianSpouseMiddleName}
            className="border border-slate-500 h-[35px] w-[100%] py-1 rounded-md font-bold text-center overflow-hidden px-1"
          />
        </section>
      </span>
      <h1 className="text-md font-bold text-red-500">Sibling Information : </h1>
