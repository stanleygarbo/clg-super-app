const Date = () => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-7 justify-center">
      {/* Monday */}
      <section className="flex flex-col gap-3 text-lg border-2 border-red-200 hover:border-blue-300 p-5 rounded-md w-[350px] group h-[250px] overflow-auto overflow-y-scroll no-scrollbar">
