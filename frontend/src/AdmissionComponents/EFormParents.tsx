...
const EFormParents = () => {
  return (
    <div className="">
      <div className="p-10">
        <form action="" className="pb-10 border-4 flex flex-col border-black">
          ...
          <div className="px-[5rem]">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-row gap-3 ">
                <input
                  type="text"
                  className="w-[765px] pl-5 pl-5"
                  placeholder="SPOUSE'S NAME (IF GUARDIAN IS MARRIED)"
                />
                <input
                  type="text"
                  className="w-[765px] pl-5"
